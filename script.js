...
function handleWhatsappBooking() {
  ...
  if (pickupCoords && dropoffCoords) {
    coordsInfo = '\nPickup Coords: ' + pickupCoords[0].toFixed(5) + ', ' + pickupCoords[1].toFixed(5)
               + '\nDropoff Coords: ' + dropoffCoords[0].toFixed(5) + ', ' + dropoffCoords[1].toFixed(5);
  }
